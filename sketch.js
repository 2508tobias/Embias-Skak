...
function mouseClicked() {
  ...
  for (var i = 0; i < hvidebrikker.length; i++) {
    ...
    } else if (hvidebrikker[i].matrixPos.x == selectPosX && hvidebrikker[i].matrixPos.y == selectPosY && hvidebrikker[i].sel == true) {
      hvidebrikker[i].sel = false;
    }
    if (hvidebrikker2[i].matrixPos.x == selectPosX && hvidebrikker2[i].matrixPos.y == selectPosY && hvidebrikker2[i].sel == false) {
      hvidebrikker2[i].sel = true;
    } else if (hvidebrikker2[i].matrixPos.x == selectPosX && hvidebrikker2[i].matrixPos.y == selectPosY && hvidebrikker2[i].sel == true) {
      hvidebrikker2[i].sel = false;
    }
    if (sortebrikker[i].matrixPos.x == selectPosX && sortebrikker[i].matrixPos.y == selectPosY && sortebrikker[i].sel == false) {
      sortebrikker[i].sel = true;
    } else if (sortebrikker[i].matrixPos.x == selectPosX && sortebrikker[i].matrixPos.y == selectPosY && sortebrikker[i].sel == true) {
      sortebrikker[i].sel = false;
    }
    if (sortebrikker2[i].matrixPos.x == selectPosX && sortebrikker2[i].matrixPos.y == selectPosY && sortebrikker2[i].sel == false) {
      sortebrikker2[i].sel = true;
    } else if (sortebrikker2[i].matrixPos.x == selectPosX && sortebrikker2[i].matrixPos.y == selectPosY && sortebrikker2[i].sel == true) {
      sortebrikker2[i].sel = false;
    }
  }
}
